  ...
  <el-dialog title="新增部门" :visible="showDialog" @close="btnCancel">
    ...
    <el-form label-width="120px" :model="formData" :rules="rules" ref="deptForm">
      ...
      <el-form-item label="部门负责人" prop="manager">
        <el-select style="width:80%" placeholder="请选择" @focus="getEmployeeSimple" v-model="formData.manager">
...
<script>
import { getDepartmentsApi, getEmployeeSimpleApi, addDepartmentsApi } from '@/api/departments'
export default {
  name: 'add-dept',
  // 检查用户名有没有重复
  props: {
